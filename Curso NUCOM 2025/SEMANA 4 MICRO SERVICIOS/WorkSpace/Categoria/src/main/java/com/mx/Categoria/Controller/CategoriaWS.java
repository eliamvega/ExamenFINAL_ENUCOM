...
public class CategoriaWS {
    ...
    @Operation(summary = "Listar categoria", description = "Lista las categorias de videojuegos existentes mediante un id" )
    @GetMapping
    ...
    @Operation(summary = " Buscar categoria por ID", description = "Busca mediante el ID de una categoria en la base de datos y la muestra ")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Editar una categoria", description = "Edita una categoria existente en la base de datos y la actualiza")
    @PutMapping
    ...
    @Operation(summary = "Eliminar categoria ", description = "Elina una categoria mediante un ID de la base de datos")
    @DeleteMapping("/{id}")
    ...
    @Operation(summary = "Listar por genero", description = "Lista las categorias mediante un genero desde la base de datos")
...
//http://localhost:8011/categoria/videojuegos/
    @Operation(summary = "Traer categoria y sus videojuegos", description = "Manda a traer la categortia y el videojuego asociado a ella desde la base de datos de categoria y de videojuego")
