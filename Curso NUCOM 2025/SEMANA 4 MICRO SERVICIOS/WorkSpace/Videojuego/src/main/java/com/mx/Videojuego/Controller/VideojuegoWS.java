...
public class VideojuegoWS {
	...
	@Operation(summary = "Listar videojuegos", description = "obtener todos los videojuegos ordenados por Id de la base de datos ")
	...
	@Operation(summary ="buscar videojuego por categoria", description = "se busa el video juego por la categoria segun pertenezca")
	...
	@Operation(summary = "buscar videojuegos por desarroladora", description = "se buscar por el video juego por el id de desarroladora en desarroladora")
