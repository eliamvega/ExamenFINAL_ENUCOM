package com.mx.RolService.Controller;
...
import com.mx.RolService.Feign.IRolFeign;
import com.mx.RolService.Service.IRolServiceImp;
    ...
    public ResponseEntity<String> guardar(@RequestBody Rol r) {
	 ...
	 @DeleteMapping("/eliminar")
	  ...
	  @Autowired
	    ...
	    public ResponseEntity<?> obtenerUsuariosPorRol(@PathVariable Long rolId) {
	        List<UsuarioDTO> usuarios = feign.obtenerUsuariosPorRol(rolId);
	        if (usuarios.isEmpty()) {
