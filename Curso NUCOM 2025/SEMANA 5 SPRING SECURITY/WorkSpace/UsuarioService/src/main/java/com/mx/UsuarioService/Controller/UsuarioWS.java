...
import com.mx.UsuarioService.Service.UsuarioServiceImp;

@RestController
@RequestMapping(path = "api/usuario")
//@CrossOrigin(origins = "*") en este caso de micro servicios ya no va aqui el cross porque se pone en el ApiGateway
...
//CREAR UN CONTROLADOR QUE BUSQUE POR ROL ID 
	 //PASO 1
	 
	 @GetMapping("/por-rol/{rolId}")
	    public List<Usuario> buscarPorRolId(@PathVariable Long rolId) {
	        return service.buscarPorRolId(rolId);
	    }
}
